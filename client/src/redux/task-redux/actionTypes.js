...
export const SINGLE_TASK_GET_REQUEST = "SINGLE_TASK_GET_REQUEST";
export const SINGLE_TASK_GET_SUCCESS = "SINGLE_TASK_GET_SUCCESS";
export const SINGLE_TASK_GET_FAILURE = "SINGLE_TASK_GET_FAILURE";
